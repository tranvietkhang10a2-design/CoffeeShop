...
public class CoffeeShopDbContext : DbContext
{
    ...
    protected override void OnModelCreating(ModelBuilder modelBuilder)
    {
       ...
       new Product { Id = 3, Name = "United Kingdom", Price = 15, Detail = "UK product", ImgUrl = "https://insanelygoodrecipes.com/wp-content/uploads/2020/07/Cup-Of-Creamy-Coffee1024x536.webp" },
        ...
        new Product { Id = 6, Name = "France", Price = 35, Detail = "France product", ImgUrl = "https://insanelygoodrecipes.com/wp-content/uploads/2020/07/Cup-Of-Creamy-Coffee1024x536.webp" }
        );
    }
}
